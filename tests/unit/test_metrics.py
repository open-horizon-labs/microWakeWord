...
class TestComputeMetrics:
    ...
    def test_perfect_classification(self):
        ...
        metrics = compute_metrics(
            true_positives=100, true_negatives=100, false_positives=0, false_negatives=0
        )
    ...
    def test_no_true_positives(self):
        ...
        metrics = compute_metrics(
            true_positives=0, true_negatives=100, false_positives=10, false_negatives=10
        )
    ...
    def test_balanced_errors(self):
        ...
        metrics = compute_metrics(
            true_positives=80, true_negatives=70, false_positives=30, false_negatives=20
        )
...
class TestComputeFalseAcceptsPerHour:
    ...
    def test_cooldown_period(self):
        ...
        faph = compute_false_accepts_per_hour(
            probabilities, cutoffs, ignore_slices_after_accept=10, step_s=0.01
        )
...
class TestGenerateROCCurve:
    ...
    def test_basic_roc_curve(self):
        ...
        x, y, c = generate_roc_curve(
            false_accepts_per_hour, false_rejections, cutoffs, max_faph=2.0
        )
