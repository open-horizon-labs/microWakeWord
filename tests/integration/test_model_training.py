...
class TestModelTrainingPipeline:
    ...
    def mock_training_data(self, tmp_path):
        ...
        RaggedMmap.from_lists(out_dir=str(train_dir), lists=[train_data], batch_size=10)

        RaggedMmap.from_lists(out_dir=str(val_dir), lists=[val_data], batch_size=5)
    ...
    def test_model_mode_switching(self, minimal_model_config):
        ...
        with patch(
            "microwakeword.utils.modes.get_input_data_shape", return_value=(1, 40)
        ):
