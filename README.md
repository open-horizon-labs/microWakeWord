...
## Open Horizon Labs recipes

The [HiPhi Kizz recipe](recipes/kizz/README.md) adds a reproducible,
manifest-driven path for training `Kizz` and natural pronunciations of
`HiPhi Kizz` as one wake class, with explicit near-sounding hard negatives and
ambient false-accept-first model selection.
